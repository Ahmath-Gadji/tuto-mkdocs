...
* b – baay b-: père | bunt b-: porte | bow: aboyer | bëtt: percer, passer à travers | bët b- (1) : oeil
* d – dagan: être permis / loisible | daje: se réunir | dàtt b-: tronc d’arbre | dégmal: être imminent | déggal (2): obeir
* f – for: ramasser | fegu(3): se protéger | feddali: raffermir, fortifier | faatu: mourir
* g – gag: avoir un trou de mémoire, commettre une erreur | gawar g: cavalier | gàddaay g-: s’exiler | gaaw: être rapide | ga: obliger | gaa (4): certes | gaw: encercler, cerner
* k – kamaj: éteindre | keppaar: endroit ombragé, ombre portée d’un arbre | kersa g-: pudeur, retenue | kort: jeter un sort
* l – lakk: brûler | lem: plier | lëndëm g-: obscurité | lingeer b-: titre de noblesse que porte une femme de sang royal  
* m – mar: avoir soif | moroom m-: camarade  
* n – nafar: réviser | naw: admirer  
...
<div class="annotate" markdown>
* c – C’est le son que l’on entend dans le nom de famille **Thi**am (en écriture française) et qui s’écrit normalement **Caam** en wolof  
    * **`Exemple`**: carax y-: sandales | ceeb b-: riz | cofeel g-: amour, sympathie | coroxaan: avaler de travers | coobare g-: volonté, agrément | cuuraay l-: encens | cant g-: remerciement, reconnaissance
...
* j – approximativement ce qu’on entend en français dans **“dieu”**. Désormais pensez à l’utiliser à la place de **“di”**.   
    * **`Exemple`**:  jabar j-: épouse | jaan j-: serpent | jàmbat: se plaindre | jéem: essayer | jéex: fouiller  
* ñ – C’est le **“gn”** du français (agneau). L’écriture **“gn”** n’existe pas en wolof. Il faudra utiliser ñ.  
    * **`Exemple`**: ñaw: coudre | ñagas: être rugueux | ñaan: demander | ñaar: deux | ñaareel: deuxième (on peut écrire aussi 2eel, 3eel (ñetteel), 4eel (ñenteel) etc.) | ñaare: Quelquefois, parfois | ñox b-: trompe d’éléphant   
* x – C’est le son que l’on a tendance à transcrire par **“kh”;** cette écriture n’existe pas en wolof.  
    * xala g-: arc
    * xal w-: braise
...
1.  Le suffixe **-adi** a souvent une valeur de négation, d'opposition. Exemples:
    ...
    * jekk: être convenable, bien fait, élégant ⇒ jekk**`adi`**: être correct, mal en point, indisposé, dans la gêne
...
!!! question "Adressons une question que vous vous posez probablement."
    ...
    En wolof, le nom doit être marqué d’une consonne qui indique **la classe à laquelle il appartient**. Cette consonne est appelée **`indice de classe` ou `classificateur`**. On dit que le wolof est une **langue à classes nominales** [^1]. Pour faire le parallèle avec le français, on peut dire que de base, il y a 3 classes en français: masculin (le), féminin (la), pluriel (les). Ces classes varient au cas indéfini et deviennent: un, une, des. En wolof, il y en a 10 😱 !!! Étant un **`indicateur sémantique`**, un emploi inhabile d’un classificateur changera complètement le sens du mot.
    ...
    * :octicons-log-16: **Exemple 2**: xar b**i**: grand récipient en bois en forme de calebasse | xar mi: mouton | xar wi: chaque partie d’une unité fendue.
    ...
    !!! tip
        ...
        * **a**b xarit: un ami | **a**g ndaw: une jeunesse | **a**m xar: un mouton ...
...
* q – le son de cette lettre n’existe pas en français. En wolof, c’est un peu l’équivalent de la lettre **x** doublée (**xx**)**.** On verra en détail ce son dans la [section sur la gémination (lettre doublée)](./3-gemination_sons_doubles_lettres.md).  Cette lettre **`ne commence jamais un mot wolof`**. Pour comprendre la différence de prononciation avec la lettre **x** et le son produit par **kk**, essayer de prononcer les mots suivants:  
    * ya**x** b-: os | yà**q**: abîmer, gâter, détériorer | ya**kk**: mettre dans un plat (le contenu cuit d’une marmite) | tà**q**amtiku: saliver | jax: remuer mélanger / sonder, tester | jà**q**: être dans l’inquiétude | jà**kk**: regarder fixement   
* w – est le son qu’on entend au début dans “oui” en français  
    * woo: appeler | walis: siffler avec la bouche | wal: soupirer, souffler | wax: parler | weer w-: lune | wér: être en bonne santé | wujj w-: coépouse  
* ŋ – On l’appelle **n à long jambage droit.** C’est le son terminal que l’on attend dans les mots anglais au progressif: Park**ing**, do**ing**, liv**ing**,   
